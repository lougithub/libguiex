...
namespace guiex
{
	...
	//------------------------------------------------------------------------------
	CGUIListBoxItem::CGUIListBoxItem( const CGUIString& rName, const CGUIString& rSceneName )
		:CGUIItemBase(StaticGetType(), rName, rSceneName)
	{
		InitListboxItem();
	}
	//------------------------------------------------------------------------------
	CGUIListBoxItem::CGUIListBoxItem( const CGUIString& rType, const CGUIString& rName, const CGUIString& rSceneName )
