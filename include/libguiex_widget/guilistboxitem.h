...
namespace guiex
{
	...
	*/
	...
	public:
		...
		*/
		CGUIListBoxItem( const CGUIString& rName, const CGUIString& rProjectName );
	...
	protected:
		...
		* for derived class
		*/
		CGUIListBoxItem( const CGUIString& rType, const CGUIString& rName, const CGUIString& rProjectName );
