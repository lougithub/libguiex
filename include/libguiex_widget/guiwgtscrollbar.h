...
namespace guiex
{
	...
	*/ 
	...
	public:
		...
		* @brief constructor
		*/
		CGUIWgtScrollbar( const CGUIString& rName, const CGUIString& rProjectName );
	...
	protected:
		...
		* for derived class
		*/
		CGUIWgtScrollbar( const CGUIString& rType, const CGUIString& rName, const CGUIString& rProjectName );
