...
//============================================================================// 
/**
 * @brief used to declare that this class will be a singleton,
 * should be used in the scope of class declare.
 * @param classname class name
 */
#define GUI_SINGLETON_DECLARE(classname)		\
	friend class ::guiex::CGUISingleton<classname>

/**
 * @brief used to implement the singleton, should be used out of
 * the scope of the class, but in the header file.
 * @param classname class name
 * @param singletonname name of singleton
 */
#define GUI_SINGLETON_IMPLEMENT(classname, singletonname)	\
	typedef ::guiex::CGUISingleton<classname> singletonname
